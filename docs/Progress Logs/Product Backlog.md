...
|---|---|---|---|---|
| [[US-E1-01]] | ระบบค้นหาภาพและตรรกะของ Zoo Detective | High | S1 | ✅ Done |
| [[US-E1-02]] | UI และ Visual Feedback ของ Zoo Detective | High | S2 | 🔵 In Progress |
| [[US-E1-03]] | ระบบสายพานลำเลียงและฟิสิกส์ของ Zoo Feeder | High | S1 | ✅ Done |
| [[US-E1-04]] | ระบบสุ่มสัตว์และอาหารใน Zoo Feeder | Med | S2 | 🔵 In Progress |
| [[US-E1-05]] | ระบบคลังคำถามและประมวลผล Context Clues | Med | S1 | ✅ Done |
| [[US-E1-06]] | UI สำหรับการตอบคำถามภาษาไทย (Context Clues) | Med | S2 | ⚪ Not Started |
...
| ID | User Story | Priority | Sprint | Status |
|---|---|---|---|---|
| [[US-E2-01]] | ออกแบบและสร้าง Table ใน Supabase | High | S2 | ⚪ Not Started |
