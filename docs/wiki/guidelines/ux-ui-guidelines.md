...
This document serves as the master guideline for all UX/UI improvements in the project. Any AI agent or developer making UI changes MUST refer to this document to maintain consistency.
