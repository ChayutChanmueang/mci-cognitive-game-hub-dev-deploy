...
**Status:** ✅ Done (Sprint 7) — AC#1–5 เสร็จ (v0.15.0, ยืนยันมือถือ); AC#6 (emoji popup จบโปรแกรม → คุณตา/คุณยาย) เสร็จ v0.20.0 พร้อม US-E7-04; ยืนยันการแสดงผลโดยเจ้าของงาน
...
6. [x] **Popup "ยินดีด้วย คุณเล่นจบโปรแกรมทั้งหมดจนครบ 14 วันแล้ว"** (`showProgramCompletionPopup`) — เปลี่ยน emoji 🧓 เป็น **รูปคุณตา/คุณยายตามเพศ** (`*_finish-line.png`) + เงา + ปุ่มเขียว ใน Frame_Form_Panel (เสร็จ v0.20.0 พร้อม US-E7-04)
...
- [x] **(AC#6)** `showProgramCompletionPopup` ใช้ตัวละครคุณตา/คุณยายตามเพศ (finish-line) + `.character-shadow` + ปุ่มเขียว ผ่าน `renderFramePopupMarkup`; `game-hub-screen.js` ส่ง `gender: options.patientGender` (v0.20.0)
