...
**Goal:** รับงานที่เลื่อนจาก Sprint 09 — export ครบชุด, low-end perf (A10s), system font scale — รวมกับ P0 gameplay ที่ยังค้าง (ถ้ายังไม่ ship ใน Sprint 09)
**Timeline:** TBD (หลัง Sprint 09)
**Release target:** TBD — วางแผนเมื่อเริ่ม sprint
...
| [US-E9-07](../user-stories/US-E9-07.md) | Optimize สเปคต่ำ — เอฟเฟคเก่งมาก + Phaser (Galaxy A10s) | P0 | 📋 Backlog |
| [US-E9-09](../user-stories/US-E9-09.md) | Layout ทนต่อการขยายฟอนต์ระบบ (System Font Scale) | P1 | 📋 Backlog |

> Owner ยืนยัน 2026-07-14: ทั้ง 3 stories **ไม่ทำใน Sprint 09** — คง priority เดิม รอวางแผน release ตอน kickoff Sprint 10
