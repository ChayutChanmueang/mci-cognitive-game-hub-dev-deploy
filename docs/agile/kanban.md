...
## 📋 Backlog (Prioritized)
- [ ] [US-E4-03](user-stories/US-E4-03.md) บันทึกข้อมูลเชิงลึก (Accuracy, RT, Fatigue Effect)
- [ ] [US-E5-01](user-stories/US-E5-01.md) ระบบ Admin Login เพื่อดูข้อมูลผู้ป่วย
- [ ] [US-E5-02](user-stories/US-E5-02.md) ระบบส่งออกข้อมูลเป็นไฟล์ CSV
...
- [ ] TD-DB-01 Database Normalization & Column Renaming
...
- [ ] [US-E1-04](US-E1-04.md) Zoo Feeder Interaction Logic
- [ ] [US-E1-05](US-E1-05.md) Context Clues Data Logic
- [ ] [US-E1-06](US-E1-06.md) Context Clues UI & Thai Support
- [ ] [US-E1-07](US-E1-07.md) Symmetry Decor Logic & Mirroring
- [ ] [US-E1-08](US-E1-08.md) Postcard Reader & Memory Polish
- [ ] [US-E2-01](US-E2-01.md) Supabase Table Setup
- [ ] [US-E2-02](US-E2-02.md) Authentication Integration
- [ ] [US-E2-03](US-E2-03.md) Score & History API
- [ ] [US-E3-01](US-E3-01.md) Accessibility Basics (Large Buttons)
- [ ] [US-E3-02](US-E3-02.md) Thai Voice Over Service
- [ ] [US-E3-03](US-E3-03.md) Game Hub & Navigation Flow
