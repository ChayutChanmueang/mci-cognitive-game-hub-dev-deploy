...
export default class StartMenuScene extends Phaser.Scene {
    constructor() {
        super('context-clues-start-menu-scene');
    }

    preload() {
        this.load.image('background', 'assets/context-clues/etc/BG.png');
    }
    ...
    create() {
        ...
        // Play BGM
        EventBus.emit('audio:bgm', 'context-clues');
        ...
        if (uiRoot) {
            this.startMenuPanel = new StartMenuPanel(uiRoot, {
                ...
                panelClass: 'result-panel--context-clues',
            });
            this.startMenuPanel.render();
        }

        const handleStartGame = () => {
            this.scene.start('gameplay-scene', { level });
        };
